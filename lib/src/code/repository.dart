...
class GenerateRepository extends CodeGeneratorClass {
  ...
  String generate({
    ...
    final withService =
        allGeneratedTypes?.contains(GenerateType.service) == true;
    final imports = [
      '''import 'package:injectable/injectable.dart';''',
      if (projectName != null && withService)
        '''import 'package:$projectName/webservice/${name.toSnakeCase()}/${name.toSnakeCase()}_service.dart';''',
    ]..sort();
